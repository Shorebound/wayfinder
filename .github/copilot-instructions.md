...
- Prefer value semantics and RAII over raw pointers and manual resource management. Use smart pointers (`std::unique_ptr`, `std::shared_ptr`) where ownership is shared or non-trivial.
