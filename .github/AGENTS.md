...
- **Sandbox apps use explicit `main()` with direct plugin construction.** There is no DLL plugin system. Each sandbox (journey, waystone) directly constructs its root plugin and passes it to `Application`.
