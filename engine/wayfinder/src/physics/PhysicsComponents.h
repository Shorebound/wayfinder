...
namespace Wayfinder
{
     ...
     *
     * Authored fields (Type, Mass, GravityFactor, LinearVelocity, AngularVelocity)
     * are serialised to TOML. RuntimeBodyId is set at runtime when the Jolt body
     * is created and is never serialised.
     */
