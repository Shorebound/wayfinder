...
namespace Wayfinder
{
     ...
     *
     * Resource counts are resolved from one of three sources (in priority order):
     * 1. Runtime Slang compilation path: SPIR-V analysis of freshly compiled bytecode.
     * 2. Build-time manifest: shader_manifest.json generated by wayfinder_shader_manifest.
     * 3. SPIR-V analysis of pre-compiled .spv files (fallback if no manifest loaded).
     */
    ...
    private:
        ...
        {
            ShaderResourceCounts Vertex{};
            ShaderResourceCounts Fragment{};
        };
