...
// Reads SceneColor texture and writes to swapchain (simple blit).
...
[[vk::binding(0, 2)]]
Texture2D<float4> SceneColorTex : register(t0, space2);
...
{
    return SceneColorTex.Sample(PointSampler, input.TexCoord);
}
